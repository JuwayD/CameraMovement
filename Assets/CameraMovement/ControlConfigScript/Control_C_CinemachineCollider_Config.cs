...
namespace CameraMovement{
    [CreateAssetMenu(menuName = "创建C_CinemachineCollider")]
    public class Control_C_CinemachineCollider_Config :CameraMovementControlConfigBase
    {
       public override Type AttachControlField => typeof(Cinemachine.CinemachineCollider);
       ...
       [UnityEngine.TooltipAttribute("The way in which the Collider will attempt to preserve sight of the target.")]
            public ConfigItem <Cinemachine.CinemachineCollider.ResolutionStrategy> m_Strategy;
