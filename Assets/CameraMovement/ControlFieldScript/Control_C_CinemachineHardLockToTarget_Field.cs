...
namespace CameraMovement{
    public class Control_C_CinemachineHardLockToTarget_Field :ICameraMovementControlField<Cinemachine.CinemachineHardLockToTarget>
    {
       ...
       [UnityEngine.TooltipAttribute("How much time it takes for the position to catch up to the target's position")]
        ...
        public void AddByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority, ref Cinemachine.CinemachineHardLockToTarget target, Dictionary<int, RuntimeTemplate> templateDict)
        {
        ...
        public void RemoveByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority, ref Cinemachine.CinemachineHardLockToTarget target, Dictionary<int, RuntimeTemplate> templateDict)
        {
            if(sourceConfig == null) return;
            if(sourceConfig.AttachControlField != AttachControlField) return;
            CameraMovement.Control_C_CinemachineHardLockToTarget_Config source = (CameraMovement.Control_C_CinemachineHardLockToTarget_Config)sourceConfig;
