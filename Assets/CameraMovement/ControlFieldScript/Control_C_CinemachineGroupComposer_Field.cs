        ...
        public class Control_C_CinemachineGroupComposer_Field :ICameraMovementControlField
    {
       ...
       [UnityEngine.TooltipAttribute("Force target to center of screen when this camera activates.  If false, will clamp target to the edges of the dead zone")]
        ...
        public void AddByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority)
        {
            ...
            if(source.m_FramingMode.IsUse) m_FramingMode.Add(new MixItem<Cinemachine.CinemachineGroupComposer.FramingMode>(id, priority, source.m_FramingMode.Value));
            if(source.m_FrameDamping.IsUse) m_FrameDamping.Add(new MixItem<System.Single>(id, priority, source.m_FrameDamping.Value));
            if(source.m_AdjustmentMode.IsUse) m_AdjustmentMode.Add(new MixItem<Cinemachine.CinemachineGroupComposer.AdjustmentMode>(id, priority, source.m_AdjustmentMode.Value));
        ...
        public void RemoveByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority)
        {
            ...
            if(source.m_FramingMode.IsUse) m_FramingMode.Remove(new MixItem<Cinemachine.CinemachineGroupComposer.FramingMode>(id, priority, source.m_FramingMode.Value));
            if(source.m_FrameDamping.IsUse) m_FrameDamping.Remove(new MixItem<System.Single>(id, priority, source.m_FrameDamping.Value));
            if(source.m_AdjustmentMode.IsUse) m_AdjustmentMode.Remove(new MixItem<Cinemachine.CinemachineGroupComposer.AdjustmentMode>(id, priority, source.m_AdjustmentMode.Value));
        ...
        public void ControlCinemachine(object targetObj, Dictionary<int, RuntimeTemplate> templateDict)
        {
            ...
            target.m_FramingMode = m_FramingMode.Value;
            if (templateDict.ContainsKey(m_FrameDamping.Id))
                target.m_FrameDamping = templateDict[m_FrameDamping.Id].Config.alertCurve.Evaluate(templateDict[m_FrameDamping.Id].CostTime / templateDict[m_FrameDamping.Id].Config.duration);
            target.m_FrameDamping = m_FrameDamping.Value;
