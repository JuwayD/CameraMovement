...
namespace CameraMovement{
    public class Control_C_CinemachinePOV_Field :ICameraMovementControlField<Cinemachine.CinemachinePOV>
    {
       ...
       [UnityEngine.HideInInspector]
        ...
        public void AddByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority, ref Cinemachine.CinemachinePOV target)
        {
            ...
            m_VerticalAxis?.AddByConfig(source.m_VerticalAxis, id, priority, ref target.m_VerticalAxis);
                if(source.m_VerticalRecentering != null && m_VerticalRecentering == null) m_VerticalRecentering = new Control_C_AS_Recentering_Field();
            m_VerticalRecentering?.AddByConfig(source.m_VerticalRecentering, id, priority, ref target.m_VerticalRecentering);
                if(source.m_HorizontalAxis != null && m_HorizontalAxis == null) m_HorizontalAxis = new Control_C_AxisState_Field();
            m_HorizontalAxis?.AddByConfig(source.m_HorizontalAxis, id, priority, ref target.m_HorizontalAxis);
            ...
            m_HorizontalRecentering?.AddByConfig(source.m_HorizontalRecentering, id, priority, ref target.m_HorizontalRecentering);
        ...
        public void RemoveByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority, ref Cinemachine.CinemachinePOV target)
        {
            if(sourceConfig == null) return;
            if(sourceConfig.AttachControlField != AttachControlField) return;
            CameraMovement.Control_C_CinemachinePOV_Config source = (CameraMovement.Control_C_CinemachinePOV_Config)sourceConfig;
            ...
            m_VerticalAxis?.RemoveByConfig(source.m_VerticalAxis, id, priority, ref target.m_VerticalAxis);
            m_VerticalRecentering?.RemoveByConfig(source.m_VerticalRecentering, id, priority, ref target.m_VerticalRecentering);
            m_HorizontalAxis?.RemoveByConfig(source.m_HorizontalAxis, id, priority, ref target.m_HorizontalAxis);
            m_HorizontalRecentering?.RemoveByConfig(source.m_HorizontalRecentering, id, priority, ref target.m_HorizontalRecentering);
                if(source.m_ApplyBeforeBody.IsUse)
                {
