        ...
        public class Control_C_CIL_ImpulseReaction_Field :ICameraMovementControlField
    {
       ...
       [UnityEngine.TooltipAttribute("How long the secondary reaction lasts.")]
        ...
        public void AddByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority)
        {
            ...
            if(source.m_Duration.IsUse) m_Duration.Add(new MixItem<System.Single>(id, priority, source.m_Duration.CalculatorExpression, source.m_Duration.Value));
        }
        public void RemoveByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority)
        {
            ...
            if(source.m_Duration.IsUse) m_Duration.Remove(new MixItem<System.Single>(id, priority, source.m_Duration.CalculatorExpression, source.m_Duration.Value));
        }
        ...
        public void ControlCinemachine(object targetObj, Dictionary<int, RuntimeTemplate> templateDict)
        {
            ...
            if (templateDict.ContainsKey(m_Duration.Id))
                target.m_Duration = templateDict[m_Duration.Id].Config.alertCurve.Evaluate(templateDict[m_Duration.Id].CostTime / templateDict[m_Duration.Id].Config.duration) * m_Duration.Value;
            target.m_Duration = (System.Single)m_Duration.Value;
        }
    }
}
