        ...
        public class Control_CinemachineCameraOffset_Field :ICameraMovementControlField<CinemachineCameraOffset>
    {
       ...
       [UnityEngine.TooltipAttribute("If applying offset after aim, re-adjust the aim to preserve the screen position of the LookAt target as much as possible")]
        ...
        public void AddByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority)
        {
            ...
            if(source.m_Offset.IsUse) m_Offset.Add(new MixItem<UnityEngine.Vector3>(id, priority, source.m_Offset.CalculatorExpression, source.m_Offset.Value, source.m_Offset.IsUse));
            ...
            if(source.m_PreserveComposition.IsUse) m_PreserveComposition.Add(new MixItem<System.Boolean>(id, priority, source.m_PreserveComposition.CalculatorExpression, source.m_PreserveComposition.Value, source.m_PreserveComposition.IsUse));
        }
        public void RemoveByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority)
        {
            ...
            if(sourceConfig.AttachControlField != AttachControlField) return;
            CameraMovement.Control_CinemachineCameraOffset_Config source = (CameraMovement.Control_CinemachineCameraOffset_Config)sourceConfig;
            if(source.m_Offset.IsUse) m_Offset.Remove(new MixItem<UnityEngine.Vector3>(id, priority, source.m_Offset.CalculatorExpression, source.m_Offset.Value, source.m_Offset.IsUse));
            ...
            if(source.m_PreserveComposition.IsUse) m_PreserveComposition.Remove(new MixItem<System.Boolean>(id, priority, source.m_PreserveComposition.CalculatorExpression, source.m_PreserveComposition.Value, source.m_PreserveComposition.IsUse));
        }
