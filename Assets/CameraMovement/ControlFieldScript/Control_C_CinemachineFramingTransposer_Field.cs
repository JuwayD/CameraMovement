    ...
    public class Control_C_CinemachineFramingTransposer_Field :ICameraMovementControlField<Cinemachine.CinemachineFramingTransposer>
    {
       ...
       [UnityEngine.TooltipAttribute("If adjusting Orthographic Size, will not set it higher than this.")]
        ...
        public void AddByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority, ref Cinemachine.CinemachineFramingTransposer target, Dictionary<int, RuntimeTemplate> templateDict)
        {
            ...
            CameraMovement.Control_C_CinemachineFramingTransposer_Config source = (CameraMovement.Control_C_CinemachineFramingTransposer_Config)sourceConfig;
                ...
                if(source.m_CameraDistance.IsUse)
                {
                   ...
                   m_CameraDistanceAlertInit = target.m_CameraDistance - templateDict[m_CameraDistance.Id].Config.alertCurve.Evaluate(templateDict[m_CameraDistance.Id].CostTime / templateDict[m_CameraDistance.Id].Config.duration) * (targetValue - m_CameraDistanceAlertInit);
                }
                ...
                if(source.m_DeadZoneDepth.IsUse)
                {
                   ...
                   m_DeadZoneDepthAlertInit = target.m_DeadZoneDepth - templateDict[m_DeadZoneDepth.Id].Config.alertCurve.Evaluate(templateDict[m_DeadZoneDepth.Id].CostTime / templateDict[m_DeadZoneDepth.Id].Config.duration) * (targetValue - m_DeadZoneDepthAlertInit);
                }
        ...
        public void ControlCinemachine(ref Cinemachine.CinemachineFramingTransposer target, Dictionary<int, RuntimeTemplate> templateDict)
        {
            ...
            {
                var targetValue = (m_CameraDistance.IsExpression ? m_CameraDistance.Value : m_CameraDistance.PrimitiveValue);
                target.m_CameraDistance = Mathf.Approximately(0, templateDict[m_CameraDistance.Id].Config.duration) ? targetValue : m_CameraDistanceAlertInit + templateDict[m_CameraDistance.Id].Config.alertCurve.Evaluate(templateDict[m_CameraDistance.Id].CostTime / templateDict[m_CameraDistance.Id].Config.duration) * (targetValue - m_CameraDistanceAlertInit);
            }
            ...
            {
                var targetValue = (m_DeadZoneDepth.IsExpression ? m_DeadZoneDepth.Value : m_DeadZoneDepth.PrimitiveValue);
                target.m_DeadZoneDepth = Mathf.Approximately(0, templateDict[m_DeadZoneDepth.Id].Config.duration) ? targetValue : m_DeadZoneDepthAlertInit + templateDict[m_DeadZoneDepth.Id].Config.alertCurve.Evaluate(templateDict[m_DeadZoneDepth.Id].CostTime / templateDict[m_DeadZoneDepth.Id].Config.duration) * (targetValue - m_DeadZoneDepthAlertInit);
            }
