...
namespace CameraMovement{
    public class Control_C_CinemachineFramingTransposer_Field :ICameraMovementControlField<Cinemachine.CinemachineFramingTransposer>
    {
       ...
       [UnityEngine.TooltipAttribute("If adjusting Orthographic Size, will not set it higher than this.")]
        ...
        public void AddByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority, ref Cinemachine.CinemachineFramingTransposer target)
        {
            ...
            CameraMovement.Control_C_CinemachineFramingTransposer_Config source = (CameraMovement.Control_C_CinemachineFramingTransposer_Config)sourceConfig;
                ...
                {
                    m_CameraDistanceAlertInit = target.m_CameraDistance;
                ...
                {
                    m_DeadZoneDepthAlertInit = target.m_DeadZoneDepth;
        ...
        public void RemoveByConfig(CameraMovementControlConfigBase sourceConfig,int id,int priority, ref Cinemachine.CinemachineFramingTransposer target)
        {
            if(sourceConfig == null) return;
            if(sourceConfig.AttachControlField != AttachControlField) return;
            CameraMovement.Control_C_CinemachineFramingTransposer_Config source = (CameraMovement.Control_C_CinemachineFramingTransposer_Config)sourceConfig;
